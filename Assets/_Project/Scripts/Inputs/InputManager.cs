...
//     version 1.17.0
//     from Assets/_Project/IA_Character.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/_Project/IA_Character.inputactions".
/// </summary>
/// <remarks>
...
public partial class @IA_Character: IInputActionCollection2, IDisposable
{
    ...
    ~@IA_Character()
    {
        UnityEngine.Debug.Assert(!m_Movement.enabled, "This will cause a leak and performance issues, IA_Character.Movement.Disable() has not been called.");
    }
    ...
    public struct MovementActions
    {
        ...
        /// </summary>
        public MovementActions(@IA_Character wrapper) { m_Wrapper = wrapper; }
        /// <summary>
